...
//char ssid[] = "ULMA2";  //  Network SSID (name)
//char pass[] = "1020304050";       // Network password
const char* host = "esp8266-webupdate";
char ssid[] = "bg_wifi";  //  Network SSID (name)
char pass[] = "924@gambas";       // Network password

RestClient client = RestClient("52.220.188.123",80);
...
//  timetry=0; 
  ...
  const char* thistring = "{\"Station_ID\":\"ST001\"}";
